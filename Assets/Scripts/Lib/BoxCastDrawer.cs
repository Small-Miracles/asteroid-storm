...
public static class BoxCastDrawer {
  ...
  static float DrawDuration = .5f;
  private static void DrawBox(Vector2[] box, Color color) {
    Debug.DrawLine(box[0], box[1], color, DrawDuration);
    Debug.DrawLine(box[1], box[2], color, DrawDuration);
    Debug.DrawLine(box[2], box[3], color, DrawDuration);
    Debug.DrawLine(box[3], box[0], color, DrawDuration);
  }

  private static void ConnectBoxes(Vector2[] firstBox, Vector2[] secondBox, Color color) {
    Debug.DrawLine(firstBox[0], secondBox[0], color, DrawDuration);
    Debug.DrawLine(firstBox[1], secondBox[1], color, DrawDuration);
    Debug.DrawLine(firstBox[2], secondBox[2], color, DrawDuration);
    Debug.DrawLine(firstBox[3], secondBox[3], color, DrawDuration);
  }
